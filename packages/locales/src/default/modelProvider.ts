export default {
  ...
  'newapi.account.unbound.desc':
    'Your sign-in identity is not linked to a gateway account yet. Open the gateway, sign in with your original account, link your identity under Profile \u2192 Account Bindings, then come back and refresh.',
  'newapi.account.unbound.openPortal': 'Open gateway',
  'newapi.account.used': 'used {{amount}}',
  ...
  'newapi.noChannel.desc':
    'Switch this conversation to a billing group that serves this model, then retry. Other conversations keep their own group.',
  'newapi.noChannel.selectPlaceholder': 'Select a billing group',
  'newapi.noChannel.switchAndRetry': 'Switch group & retry',
  'newapi.noChannel.thisModel': 'this model',
  'newapi.noChannel.title':
    '"{{model}}" is not available in the billing group pinned to this conversation ({{group}})',
  'newapi.title': 'New API',
  'newapi.topicGroup.desc':
    'Choose the billing group for this conversation. It only affects this conversation — other conversations keep their own group.',
  'newapi.topicGroup.menu': 'Billing group',
  'newapi.topicGroup.title': 'Conversation billing group',
  'newapi.topicGroup.unavailable': 'Billing group switching is not available for this account.',
